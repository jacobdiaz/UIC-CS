...
public class AI_MinMax {
	...
	AI_MinMax()
	{
		System.out.println("New MINMAX");
		init_board = getBoard();

		// Is valid board information?
	...
	public String[] invertBoard(String[] board){
		for (int i = 0; i < 9 ; i++) {
			if(board[i].equals("O")){
				board[i] = "X";
	...
	private String[] getBoard()
	{
			...
			return invertBoard(boardParsed);
	}
	...
	public ArrayList<Node> getMovesList() { return movesList; }
